...
function renderCategories() {
  ...
  const fallbackImage =
    "https://firebasestorage.googleapis.com/v0/b/mirdhuna-25542.firebasestorage.app/o/images%2Fvegetable%2F1767816457376_Gemini_Generated_Image_lzr3dulzr3dulzr3.png?alt=media&token=c5cf7a9d-d500-4a39-afff-f59c17dc6816"
...
<button id="smallViewBtn" class="view-btn">Small View</button>

<div id="smallViewContainer" style="display:none;"></div>
#smallViewContainer {
  display: grid;
...
// ===== SMALL VIEW RENDER =====
function renderSmallView(menuItems) {
  const container = document.getElementById("smallViewContainer")
  container.innerHTML = ""
  ...
  menuItems.forEach(item => {
    ...
    div.querySelector(".small-add-btn").addEventListener("click", () => {
      addToCart(item) // uses your existing add to cart
    })
...
// ===== TOGGLE VIEW =====
document.getElementById("smallViewBtn").addEventListener("click", () => {
  document.getElementById("menuContainer").style.display = "none"
  document.getElementById("smallViewContainer").style.display = "grid"

  renderSmallView(menuItems) // uses your existing menu data
})
